...
$site = "view-user.php";
								  ...
								  $nurse_query=mysqli_query($conn,"select * from nurse ")or die(mysql_error());
									while($row=mysqli_fetch_array($nurse_query)){
									// $id=$row['id'];
									echo'
                  <form name="del" action="" method="POST" '; ?>onsubmit="return confirm('Are you Sure you want to delete user');" >
                  	<?php echo'
									<tr class="del ">
                                   ...
                                   <td> '.$row['nurse_id'].' </td>
									...
									echo'
                                    <td class="action">
									<input type="hidden" id="iden" value="'.$row['nurse_id'].'" name="row-id">
