...
<!--onload="initMap()"-->
   <body class="sticky-header left-side-collapsed"  >
	...
	<!-- //header-ends -->
			<div id="page-wrapper">
				<div class="graphs">
					<h3 class="blank1">Register Patient</h3>
						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="" method="POST" enctype="multipart/form-data" autocomplete="off">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" name="FName" class="form-control1" id="focusedinput" placeholder="First Name" required>
									</div>
									</div>
									...
									<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Other Name</label>
									<div class="col-sm-8">
										<input type="text" name="other" class="form-control1" id="focusedinput" placeholder="other Names" >
									</div>
									</div>
									<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" name="phone" class="form-control1" id="focusedinput" placeholder="Phone Number" required>
									</div>
									</div>
								<div class="form-group">
				...
				<div class="clearfix"> </div>
			                      ...
			                      <div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" name="postal" class="form-control1" id="focusedinput" placeholder="P.O. Box ..." required>
									</div>
									</div>
			                     <div class="form-group">
									...
									<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Year/Level</label>
									<div class="col-sm-8">
										<input type="text" name="year" class="form-control1" id="focusedinput" placeholder="Year" required>
									</div>
									</div>
									<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Reference Number</label>
									<div class="col-sm-8">
										<input type="text" name="ref" class="form-control1" id="focusedinput" placeholder="Reference Number" required>
									</div>
									</div>
									<div class="form-group">
...
/*
this changes the admins username to the username of the added user..
 		...
 		if ($numrows == 0) {
 			//$sql = "INSERT INTO users (username, password, reference,Fname, surname, other, year, gender, pnumber, email, paddress, profile) VALUES ('$username', '$password_hash', '$reference','$fname', '$surname', '$other', '$year', '$gender', '$phone', '$email', '$postal', '$profile')";
$sql = "INSERT INTO users (`username`, `password`, `reference`, `Fname`, `surname`, `other`, `year`, `gender`, `pnumber`, `email`, `paddress`, `profile`) VALUES ('$username', '$password_hash', '$reference', '$fname', '$surname', '$other', '$year', '$gender', '$phone', '$email', '$postal', '$profile')";
      ...
      $result = mysqli_query($conn, $sql);
 			...
 			if ($result) {
				...
				echo "<script type='text/javascript'> alert('Patient Added successfully!') </script>";
 				...
 				//$error = "Failure";
				echo "<script type='text/javascript'>alert('Sorry Could not Add new user')</script>";
 			}
 		}
