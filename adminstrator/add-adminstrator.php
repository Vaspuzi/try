...
<!-- Placed js at the end of the document so the pages load faster -->
   ...
   <body class="sticky-header left-side-collapsed"  onload="initMap()">
			...
			<div class="left-side-inner">
				...
				<!--sidebar nav start-->
					<ul class="nav nav-pills nav-stacked custom-nav">
						...
						<li><a href="codes.php"><i class="lnr lnr-pencil"></i> <span>Typography</span></a></li>
	...
	<!-- //header-ends -->
			<div id="page-wrapper">
				<div class="graphs">
					<h3 class="blank1">Register New Adminstrator</h3>
						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="" method="POST" enctype="multipart/form-data" autocomplete="off">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" name="pnumber" class="form-control1" id="focusedinput" placeholder="Phone Number" required>
									</div>
									</div>
								<div class="form-group">
...
/*
 		...
 		if ($numrows == 0) {
 			$sql = "INSERT INTO admin (f_name, surname, gender, pnumber, email, username, password, profile) VALUES ('$f_name', '$surname', '$gender', $pnumber, '$email', '$username', '$password_hash','$profile')";
