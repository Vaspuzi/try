...
session_start();
//&& isset($_POST['admprofile'])
/*if(isset($_POST['user']) ){
  $usern = $_POST['name'];
  $profile = $_POST['prof'];
}*/
if(isset($_SESSION['admprofile']) && isset($_SESSION['admusername'])){
			...
			<div class="left-side-inner">
				...
				<!--sidebar nav start-->
					<ul class="nav nav-pills nav-stacked custom-nav">
						...
						<li class="menu-list"><a href="#"><i class="lnr lnr-book"></i>  <span>View</span></a>
							<ul class="sub-menu-list">
					...
					<div class="col_3">
						<div class="col-md-3 widget widget1">
							<div class="r3_counter_box">
								<i class="fa fa-users" style="color: #8BC34A;"></i>
								<div class="stats">
								  <h5><?php echo users(); ?><span></span></h5>
								  <div class="grow">
									<p>Patients</p>
								  </div>
								</div>
						...
						<div class="col-md-3 widget widget1">
							<div class="r3_counter_box">
								<i class="fa fa-hospital-o" style="color: #00BCD4;"></i>
								<div class="stats">
								  <h5><?php echo nurse(); ?><span></span></h5>
						...
						<div class="col-md-3 widget widget1">
							<div class="r3_counter_box">
								<i class="fa fa-eye"></i>
								<div class="stats">
								  <h5><?php echo doctor(); ?> <span></span></h5>
						 ...
						 <div class="col-md-3 widget">
							<div class="r3_counter_box">
								<i class="fa fa-dashboard" style="color: #FFCA28;"></i>
								<div class="stats">
								  <h5><?php echo admin(); ?> <span></span></h5>
