...
<!--onload="initMap()"-->
   <body class="sticky-header left-side-collapsed"  >
	...
	<!-- //header-ends -->
			<div id="page-wrapper">
				<div class="graphs">
					<h3 class="blank1">Register Doctor</h3>
...
/*
        ...
        */
 		...
 		if ($numrows == 0) {
 			$sql = "INSERT INTO doctor (f_name, surname, gender, email, username, password, profile) VALUES ('$f_name', '$surname', '$gender', '$email', '$username', '$password_hash','$profile')";
        ...
        echo "<script type='text/javascript'> alert('Doctor Added successfully!') </script>";
 				...
 				//$error = "Failure";
        echo "<script type='text/javascript'> alert('Failed to add Doctor!') </script>";
