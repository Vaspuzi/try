...
font-size: 16px;"> Last access :<?php echo date("m/d/Y"); ?> &nbsp; <a href="logout.php" class="btn btn-danger square-btn-adjust"><i class="fa fa-sign-out"></i>Logout</a> </div>
    ...
    <label for="inputEmail3" class="col-sm-4 control-label"><h3>Patient ID</h3></label>
    <div class="col-sm-8">
      <input type="text" class="form-control" rows="3" value="<?php echo $_SESSION['iden']?>"disabled />
    </div>
  </div>
  ...
  <div class="form-group">
    <div id="messages" class="col-sm-offset-2 col-sm-10">
