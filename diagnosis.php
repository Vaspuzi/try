    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Diagnosis</a>
            </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a class="active-menu"  href="#"><i class="fa fa-user-md fa-lg"></i> Sympton Checker</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <div class="row">
                  <div class="content">
                    <div class="col-md-6">
                      <p>Get possible diagnoses to match your symptons ...</p>
                      <hr />
                    ...
                    <div class="col-md-6">
                      ...
                      <table class="table table-hover">
                        <tr>
                          <th><b><h3>Vitals</h3></b></th>
                          <th><b><h3>Measurement</h3></b></th>
                        </tr>
                        <tr>
                          <th>Body Tempreture</th>
                          <td><?php echo $_SESSION['body_temp']; ?></td>
                        </tr>
                        <tr>
                          <th>Pulse Rate</th>
                          <td><?php echo $_SESSION['pulse_rate']; ?></td>
                                              </tr>
                        <tr>
                          <th>Respiration Rate</th>
                          <td><?php echo $_SESSION['respiration_rate']; ?></td>
                        </tr>
                        <tr>
                          <th><h4><strong><i>Blood Pressure</i></strong></h4></th>
                          <th><b></b></th>
                        </tr>
                          <tr>
                          <th>Systolic</th>
                          <td><?php echo $_SESSION['systolic']; ?></td>
                        </tr>
                        <tr>
                          <th>Diastolic</th>
                          <td><?php echo $_SESSION['diastolic'] ?></td>
                        </tr>
                      </table>
                    </div>
                  </div>
