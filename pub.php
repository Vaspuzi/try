...
font-size: 16px;"> Last access : <?php echo date("m/d/Y"); ?> &nbsp; <a href="logout1.php" class="btn btn-danger square-btn-adjust"><i class="fa fa-sign-out"></i>Logout</a> </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a   href="doctor-panel.php"><i class="fa fa-user-md fa-lg"></i>Consulting</a>
                    </li>
                    <li>
                        <a class="active-menu" href="#"><i class="fa fa-sitemap fa-lg"></i> View<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="active-menu" href="view-profile-doctor.php"> Profile</a>
                            </li>
                            <li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <div class="row">
                  <div class="content">
                    <div class="col-md-6">
                      <p><h2>Enter new disease and symptoms</h2></p>
                      <hr />
  ...
  <div class="form-group">
    <label for="inputEmail3" class="col-sm-4 control-label">Disease</label>
    <div class="col-sm-8">
      <input type="text" name="disease" class="form-control" id="inputEmail3" placeholder="New disease">
    </div>
  </div>
  <div class="form-group">
    <label for="inputEmail3" class="col-sm-4 control-label">Symptom(s) </label>
    <div class="col-sm-8">
      <input type="text" name="symptom" class="form-control" id="inputEmail3" placeholder="New symptoms">
    </div>
  </div>
